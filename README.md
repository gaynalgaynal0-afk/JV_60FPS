...
[![Platform](https://img.shields.io/badge/Platform-Chrome%20|%20Edge%20|%20Brave-white.svg)]()

> **Upload in peak quality. Bypass the noise. Leave your mark.** ⚡
...
Since this is a powerful, open-source performance tool, you won't find it on the standard Chrome Web Store. You install it directly from the source. 

<details>
<summary><b>🔥 Click here for step-by-step installation instructions</b></summary>

1. **Download the Source Code**
   * Click the green `<> Code` button at the top of this repository.
   * Select **Download ZIP** and extract the folder to your computer (e.g., to your Desktop).

2. **Open Extensions Page**
   * Open Chrome (or Edge/Brave) and go to your extensions page. You can type `chrome://extensions/` into your URL bar.

3. **Enable Developer Mode**
   * Look in the top right corner of the Extensions page and toggle **Developer mode** to ON.
